...
namespace BlendShapePlayable
{
    ...
    public class BlendShapeControlClipEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            template.shape8 = EditorGUILayout.FloatField(ShapeInfo.shape8, template.shape8);
            template.shape9 = EditorGUILayout.FloatField(ShapeInfo.shape9, template.shape9);
            template.shape10 = EditorGUILayout.FloatField(ShapeInfo.shape10, template.shape10);
            EditorGUILayout.LabelField("-----EYE-----");
            template.shape11 = EditorGUILayout.FloatField(ShapeInfo.shape11, template.shape11);
            template.shape12 = EditorGUILayout.FloatField(ShapeInfo.shape12, template.shape12);
            template.shape13 = EditorGUILayout.FloatField(ShapeInfo.shape13, template.shape13);
            template.shape14 = EditorGUILayout.FloatField(ShapeInfo.shape14, template.shape14);
            template.shape15 = EditorGUILayout.FloatField(ShapeInfo.shape15, template.shape15);
            template.shape16 = EditorGUILayout.FloatField(ShapeInfo.shape16, template.shape16);
            template.shape17 = EditorGUILayout.FloatField(ShapeInfo.shape17, template.shape17);
            template.shape18 = EditorGUILayout.FloatField(ShapeInfo.shape18, template.shape18);
            template.shape19 = EditorGUILayout.FloatField(ShapeInfo.shape19, template.shape19);
            template.shape20 = EditorGUILayout.FloatField(ShapeInfo.shape20, template.shape20);
            template.shape21 = EditorGUILayout.FloatField(ShapeInfo.shape21, template.shape21);
            EditorGUILayout.LabelField("-----MTH-----");
            template.shape22 = EditorGUILayout.FloatField(ShapeInfo.shape22, template.shape22);
            template.shape23 = EditorGUILayout.FloatField(ShapeInfo.shape23, template.shape23);
            template.shape24 = EditorGUILayout.FloatField(ShapeInfo.shape24, template.shape24);
            template.shape25 = EditorGUILayout.FloatField(ShapeInfo.shape25, template.shape25);
